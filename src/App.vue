...
<template>
  <div>
    <div class="w-[calc(100%-240px)] h-[60px] fixed right-0 z-20
      bg-[#101010] bg-opacity-80 flex items-center justify-between"
    >
  ...
  <div
    class="fixed right-0 top-0 w-[calc(100%-240px)] overflow-auto h-full
